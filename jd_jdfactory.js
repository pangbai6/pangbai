...
================Loon==============
[Script]
cron "50 4,17 * * *" script-path=

===============Surge=================
东东工厂 = type=cron,cronexp="50 4,17 * * *",wake-system=1,timeout=3600,script-path=

============小火箭=========
东东工厂 = type=cron,script-path=, cronexpr="50 4,17 * * *", timeout=3600, enable=true
 */
