...
[task_local]
#东东工厂
10 0,6-23 * * * , tag=东东工厂, img-url=, enabled=true

================Loon==============
[Script]
cron "10 0,6-23 * * *" script-path=,tag=东东工厂

===============Surge=================
东东工厂 = type=cron,cronexp="10 0,6-23 * * *",wake-system=1,timeout=3600,script-path=

============小火箭=========
东东工厂 = type=cron,script-path=, cronexpr="10 0,6-23 * * *", timeout=3600, enable=true
 */
const $ = new Env('东东工厂');
