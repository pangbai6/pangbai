...
# 获取有效 config.sh 链接
get_valid_config() {
    config_list=(https://raw.githubusercontents.com/pangbai6/VIP/main/config/config.sample.sh https://raw.sevencdn.com/pangbai6/VIP/main/config/config.sample.sh https://ghproxy.com/https://raw.githubusercontent.com/pangbai6/VIP/main/config/config.sample.sh)
...
# 获取有效 extra.sh 链接
get_valid_extra() {
    extra_list=(https://raw.githubusercontents.com/pangbai6/VIP/main/config/extra.sh https://raw.sevencdn.com/pangbai6/VIP/main/config/extra.sh https://ghproxy.com/https://raw.githubusercontent.com/pangbai6/VIP/main/config/extra.sh)
...
# extra.sh 设置区设置
set_default_extra() {   
    echo -e "一、集成仓库 pangbai仓库+City仓库"
    read -p "直接回车拉取pangbai仓库，输入2回车拉取City仓库" CollectedRepo
...
# 获取有效 code.sh 链接
get_valid_code() {
    code_list=(https://raw.githubusercontents.com/pangbai6/VIP/main/config/code.sh https://raw.sevencdn.com/pangbai6/VIP/main/config/code.sh https://ghproxy.com/https://raw.githubusercontent.com/pangbai6/VIP/main/config/code.sh)
...
get_valid_task_before() {
    task_before_list=(https://raw.githubusercontents.com/pangbai6/VIP/main/config/task_before.sh https://raw.sevencdn.com/pangbai6/VIP/main/config/task_before.sh https://ghproxy.com/https://raw.githubusercontent.com/pangbai6/VIP/main/config/task_before.sh)
...
add_curl_sample() {
    if [ "$(grep -c "config.sample.sh" /ql/config/crontab.list)" != 0 ]; then
        ...
        # 获取token
        token=$(cat /ql/config/auth.json | jq --raw-output .token)
        curl -s -H 'Accept: application/json' -H "Authorization: Bearer $token" -H 'Content-Type: application/json;charset=UTF-8' -H 'Accept-Language: zh-CN,zh;q=0.9' --data-binary '{"name":"自动更新模板","command":"curl -L https://raw.githubusercontents.com/pangbai6/VIP/main/config/config.sample.sh -o /ql/sample/config.sample.sh && cp -rf /ql/sample/config.sample.sh /ql/config","schedule":"45 6,18 * * *"}' --compressed 'http://127.0.0.1:5700/api/crons?t=1627380635389'
    fi
}
run_curl_sample() {
